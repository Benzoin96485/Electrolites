...
j_0_0_mb1(JARGS)
{
    __shared__ double s_iaij[16];
    __shared__ double s_iakl[480];
    ...
    if (q_cond[pair_ij0] + q_cond[pair_kl0] < cutoff) {
        return;
    }
    ...
    for (int batch_ij = 0; batch_ij < 30; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 30; ++batch_kl) {
            ...
            int pair_ij0 = pair_ij_mapping[task_ij0];
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*30] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*30] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
            ...
            boys0_fn_reg<0>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            ...
            double *dm = dm_all + kl_loc0;
            dm_kl0 = dm[0];
            vj_ij[0] += gamma_inc[0] * dm_kl0;
            }
        }
        {
...
j_1_0_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 23; ++batch_kl) {
            ...
            int pair_ij0 = pair_ij_mapping[task_ij0];
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*23] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
            ...
            double rr = xpq*xpq + ypq*ypq + zpq*zpq;
            double theta = aij * akl * (inv_s * inv_s);
            boys0_fn_reg<1>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            double R_0_0_0_1 = zpq * gamma_inc[1];
            vj_kl0 += R_0_0_0_1 * dm_ij_cache[16];
            double R_0_0_1_0 = ypq * gamma_inc[1];
            vj_kl0 += R_0_0_1_0 * dm_ij_cache[32];
            double R_0_1_0_0 = xpq * gamma_inc[1];
...
j_1_1_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 10; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 10; ++batch_kl) {
            ...
            int pair_ij0 = pair_ij_mapping[task_ij0];
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*10] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*10] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
            ...
            double rr = xpq*xpq + ypq*ypq + zpq*zpq;
            double theta = aij * akl * (inv_s * inv_s);
            boys0_fn_reg<2>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            double R_0_0_0_1 = zpq * gamma_inc[1];
            vj_kl0 += R_0_0_0_1 * dm_ij_cache[16];
            ...
            double R_1_0_0_1 = zpq * gamma_inc[2];
            double R_0_0_0_2 = zpq * R_1_0_0_1 + 1 * gamma_inc[1];
            ...
            double R_1_0_1_0 = ypq * gamma_inc[2];
            double R_0_0_2_0 = ypq * R_1_0_1_0 + 1 * gamma_inc[1];
            ...
            double R_1_1_0_0 = xpq * gamma_inc[2];
            double R_0_2_0_0 = xpq * R_1_1_0_0 + 1 * gamma_inc[1];
...
j_2_0_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 16; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*16] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
...
j_2_1_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 30; ++batch_kl) {
            ...
            double rr = xpq*xpq + ypq*ypq + zpq*zpq;
            double theta = aij * akl * (inv_s * inv_s);
            boys0_fn_reg<3>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            double R_0_0_0_1 = zpq * gamma_inc[1];
            vj_kl0 += R_0_0_0_1 * dm_ij_cache[16];
            ...
            vj_kl0 -= R_0_0_0_1 * dm_ij_cache[0];
            vj_kl0 -= R_0_0_0_2 * dm_ij_cache[16];
            double R_2_0_0_1 = zpq * gamma_inc[3];
            double R_1_0_0_2 = zpq * R_2_0_0_1 + 1 * gamma_inc[2];
            ...
            double R_2_0_1_0 = ypq * gamma_inc[3];
            double R_1_0_2_0 = ypq * R_2_0_1_0 + 1 * gamma_inc[2];
            ...
            double R_2_1_0_0 = xpq * gamma_inc[3];
            double R_1_2_0_0 = xpq * R_2_1_0_0 + 1 * gamma_inc[2];
...
j_2_2_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 14; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 14; ++batch_kl) {
            ...
            int pair_ij0 = pair_ij_mapping[task_ij0];
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*14] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*14] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
            ...
            double rr = xpq*xpq + ypq*ypq + zpq*zpq;
            double theta = aij * akl * (inv_s * inv_s);
            boys0_fn_reg<4>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            double R_0_0_0_1 = zpq * gamma_inc[1];
            vj_kl0 += R_0_0_0_1 * dm_ij_cache[16];
            ...
            double R_3_0_0_1 = zpq * gamma_inc[4];
            double R_2_0_0_2 = zpq * R_3_0_0_1 + 1 * gamma_inc[3];
            ...
            double R_3_0_1_0 = ypq * gamma_inc[4];
            double R_2_0_2_0 = ypq * R_3_0_1_0 + 1 * gamma_inc[3];
            ...
            double R_3_1_0_0 = xpq * gamma_inc[4];
            double R_2_2_0_0 = xpq * R_3_1_0_0 + 1 * gamma_inc[3];
...
j_3_0_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 46; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*46] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
...
j_3_1_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 24; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*24] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
...
j_3_2_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 11; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*11] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
            ...
            double rr = xpq*xpq + ypq*ypq + zpq*zpq;
            double theta = aij * akl * (inv_s * inv_s);
            boys0_fn_reg<5>(gamma_inc, theta, rr, fac);
            vj_kl0 = 0.;
            vj_kl0 += gamma_inc[0] * dm_ij_cache[0];
            double R_0_0_0_1 = zpq * gamma_inc[1];
            vj_kl0 += R_0_0_0_1 * dm_ij_cache[16];
            ...
            vj_kl0 += R_0_0_0_3 * dm_ij_cache[16];
            vj_kl0 += R_0_0_0_4 * dm_ij_cache[32];
            double R_4_0_0_1 = zpq * gamma_inc[5];
            double R_3_0_0_2 = zpq * R_4_0_0_1 + 1 * gamma_inc[4];
            ...
            double R_4_0_1_0 = ypq * gamma_inc[5];
            double R_3_0_2_0 = ypq * R_4_0_1_0 + 1 * gamma_inc[4];
            ...
            double R_4_1_0_0 = xpq * gamma_inc[5];
            double R_3_2_0_0 = xpq * R_4_1_0_0 + 1 * gamma_inc[4];
...
j_4_0_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 36; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*36] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
...
j_4_1_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 18; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*18] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
...
j_5_0_mb1(JARGS)
{
    ...
    for (int batch_ij = 0; batch_ij < 48; ++batch_ij) {
        ...
        for (int batch_kl = 0; batch_kl < 26; ++batch_kl) {
            ...
            int pair_kl0 = pair_kl_mapping[task_kl0];
            if (qd_ij_max[batch_ij+blockIdx.x*48] + q_cond[pair_kl0] < cutoff &&
                qd_kl_max[batch_kl+blockIdx.y*26] + q_cond[pair_ij0] < cutoff) {
                continue;
            }
